...
## {% include icon.html icon="fa-solid fa-users" %}Tricounty Health Department
{% include list.html data="members" component="portrait" filters="role: trico" %

## {% include icon.html icon="fa-solid fa-users" %}Tooele Health Department
{% include list.html data="members" component="portrait" filters="role: toohd" %
